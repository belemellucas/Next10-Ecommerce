      ...
      <header className="px-4 pt-6 pb-4 sm:px-6">
        <div className="flex items-start justify-between space-x-3">
          <div className="h-7 flex items-center">
            ...
            >
             {isEmpty ? <Cross className="h-6 w-6" /> : <Cross className="h-6 w-6" color={"rgb(0,0,0)"}/> }
            </button>
          </div>
        </div>
      </header>
      ...
      {isEmpty ? (
        <div className="flex-1 px-4 flex flex-col justify-center items-center">
          <span className="border border-dashed border-primary rounded-full flex items-center justify-center w-16 h-16 p-12 bg-secondary text-secondary">
            <Bag className="absolute" color="rgb(255,255,255)"/>
          </span>
          <h2 className="text-white pt-6 text-2xl font-bold tracking-wide text-center">
            Your cart is empty
          </h2>
          <p className="text-white text-accents-3 px-10 text-center pt-2">
